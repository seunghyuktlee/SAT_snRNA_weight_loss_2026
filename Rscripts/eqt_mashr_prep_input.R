...
snp.prn <- fread(
  "/u/project/pajukant/seunglee/KOBS/data/genotype/comb2015-9105_9138_2020-9190/imputed/hrc1.1_phased_rsq0.3/kobs_imputed.hrc1.1.rsq0.3.maf0.1_unrelated_hg38_ld.pruned.r2.0.9.bim", 
  header = F)
